...
/*房客对房东评论路由*/
$route['user_comment_owner'] = "admin/mgruser/user_comment_owner";

/*发布房源路由*/
$route['publish_house'] = "admin/mgruser/publish_house";


/*配置房客管理页面的路由开始*/

$route['admin/mgr_user/(:num)'] = 'admin/mgruser/mgr_user/$1';
