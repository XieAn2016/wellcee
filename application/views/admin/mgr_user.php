    ...
    $(function () {
        ...
        $('.btn-search').on('click', function(){
                ...
                $.get('admin/mgruser/search_user', {keyword:keyword}, function (data) {
                    ...
                    `<tr>
                        <td><input type="checkbox" data-id="14"></td>
                        ...
                        <td><a href="#"> </a></td>
                        <td>男</td>
                        <td class="am-hide-sm-only">2016</td>
                        <td class="am-hide-sm-only"></td>
                        <td class="am-hide-sm-only">法国</td>
                        <td class="am-hide-sm-only"></td>
                        <td>
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button class="btn-edit am-btn am-btn-default am-btn-xs am-text-secondary" data-id="14"><span class="am-icon-pencil-square-o"></span>
                                        <a href="admin/mgr_user_update?userId=14">编辑</a></button>
                                    <button class="btn-disable am-btn am-btn-default am-btn-xs am-hide-sm-only" data-id="14"><span class="am-icon-copy"></span> 禁用</button>
                                    <button class="btn-delete am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" data-id="14"><span class="am-icon-trash-o"></span> 删除</button>
                                </div>
                            </div>
                        </td>
                    </tr>`
